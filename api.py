...
from broker10api.http.login import Login,_2FA
from broker10api.http.loginv2 import Loginv2
from broker10api.http.logout import Logout
from broker10api.http.getprofile import Getprofile
from broker10api.http.auth import Auth
from broker10api.http.token import Token
from broker10api.http.appinit import Appinit
from broker10api.http.billing import Billing
from broker10api.http.buyback import Buyback
from broker10api.http.changebalance import Changebalance
from broker10api.http.events import Events
from broker10api.ws.client import WebsocketClient
from broker10api.ws.chanels.get_balances import *
from broker10api.ws.chanels.get_transaction import *
from broker10api.ws.chanels.ssid import Ssid
from broker10api.ws.chanels.subscribe import *
from broker10api.ws.chanels.unsubscribe import *
from broker10api.ws.chanels.setactives import SetActives
from broker10api.ws.chanels.candles import GetCandles
from broker10api.ws.chanels.buyv2 import Buyv2
from broker10api.ws.chanels.buyv3 import *
from broker10api.ws.chanels.user import *
from broker10api.ws.chanels.get_top_assets import Get_Top_Assets
from broker10api.ws.chanels.api_game_betinfo import Game_betinfo
from broker10api.ws.chanels.instruments import Get_instruments
from broker10api.ws.chanels.get_financial_information import GetFinancialInformation
from broker10api.ws.chanels.strike_list import Strike_list
from broker10api.ws.chanels.leaderboard import Leader_Board

from broker10api.ws.chanels.get_active_exposure import Get_Active_Exposure

from broker10api.ws.chanels.get_profile import Get_profile
from broker10api.ws.chanels.traders_mood import Traders_mood_subscribe
from broker10api.ws.chanels.traders_mood import Traders_mood_unsubscribe
from broker10api.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from broker10api.ws.chanels.get_order import Get_order
from broker10api.ws.chanels.get_deferred_orders import GetDeferredOrders
from broker10api.ws.chanels.get_positions import *
 
from broker10api.ws.chanels.get_available_leverages import Get_available_leverages
from broker10api.ws.chanels.cancel_order import Cancel_order
from broker10api.ws.chanels.close_position import Close_position
from broker10api.ws.chanels.get_overnight_fee import Get_overnight_fee
from broker10api.ws.chanels.heartbeat import Heartbeat

 
from broker10api.ws.chanels.digital_option import *
from broker10api.ws.chanels.api_game_getoptions import *
from broker10api.ws.chanels.sell_option import Sell_Option
from broker10api.ws.chanels.change_tpsl import Change_Tpsl
from broker10api.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from broker10api.ws.objects.timesync import TimeSync
from broker10api.ws.objects.profile import Profile
from broker10api.ws.objects.candles import Candles
from broker10api.ws.objects.listinfodata import ListInfoData
from broker10api.ws.objects.betinfo import Game_betinfo_data
...
class Broker10API(object):
    def __init__(self, host, username, password,http_proxy_host=None,http_proxy_port=None,http_proxy_auth=None,set_ssid=None,auto_logout=True,_2FA_TOKEN=None):
        ...
        self.https_url = "https://api.trade.broker10.com/v2/login".format(host=host)
        self.wss_url = "wss://ws.trade.broker10.com/echo/websocket".format(host=host)
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <broker10api.http.resource.Resource>`.
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <broker10api.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <broker10api.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <broker10api.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <broker10api.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <broker10api.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <broker10api.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def get_profile_ws(self):
        ...
        :returns: The instance of :class:`Login
            <broker10api.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <broker10api.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
    @property
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <broker10api.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <broker10api.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <broker10api.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <broker10api.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <broker10api.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
...
# -------------------------------------------------------
    ...
    def start_websocket(self):
        ...
        while True and time.time() < started:
            try:
