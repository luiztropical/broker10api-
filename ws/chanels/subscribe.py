...
class Subscribe_Instrument_Quites_Generated(Base):
    ...
    def get_digital_expiration_time(self, duration):
        ...
        return ans
class Subscribe_Instrument_Quites_Generated_v2(Base):
    """
    {"name":"subscribeMessage","request_id":"s_257","local_time":518687,"msg":{"name":"price-splitter.client-price-generated","version":"1.0","params":{"routingFilters":{"instrument_type":"digital-option","asset_id":1,"instrument_index":151169}}}}
    """
    name = "subscribeMessage"
    def __call__(self,ACTIVE,expiration_period):  
        data = {
            "name": "price-splitter.client-price-generated",
            "params":{"routingFilters":{"instrument_type":"digital-option",
                                        "expiration_period":int(expiration_period*60),
                                        "asset_id":int(OP_code.ACTIVES[ACTIVE])}},
            "version": "1.0"
        }
        self.send_websocket_request(self.name, data)
